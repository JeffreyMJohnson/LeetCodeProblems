...
using Problems.DataStructures.Tree.BinaryTreePostOrderTraversal;

namespace Tests.DataStructures.Tree.BinaryTreePostOrderTraversal
{
  public class Tests
  {
    [Test]
    ...
    {
      var t = new Solution();
      var result = t.PostOrderTraversal(null);
    ...
    public void TraverseSingleNode()
    {
      ...
      var result = t.PostOrderTraversal(root);
