...
using Problems.DataStructures.Tree.BinaryTreeInOrderTraversal;

namespace Tests.DataStructures.Tree.BinaryTreeInOrderTraversal
{
  public class Tests
  {
    [Test]
    ...
    {
      var t = new Solution();
      var result = t.InOrderTraversal(null);
    ...
    public void TraverseSingleNode()
    {
      ...
      var result = t.InOrderTraversal(root);
